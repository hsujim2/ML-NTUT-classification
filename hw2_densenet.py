...
cnn_base = DenseNet201(weights='imagenet',include_top=False,input_shape=(img_height,img_width,3))
...
#train module
checkpoint = ModelCheckpoint("/home/t107360144/densenet", monitor='val_categorical_accuracy', verbose=1, save_best_only=True,
mode='max')
...
model.save("/home/t107360144/ML_hw2/densenet")
...
select_df.to_csv('test_densenet.csv',index= False)#存檔成csv
